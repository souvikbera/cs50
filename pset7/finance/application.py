...
def index():
    ...
    port = db.execute("SELECT shares, symbol \
...
def register():
    ...
    if request.method == "POST":
        ...
        # ensure password and verified password is the same
            ...
            return apology("Both passwords do not match")
        ...
        if not result:
            return apology("User already regisrtered")
...
def quote():
    ...
    if request.method == "POST":
        ...
        return render_template("pricequote.html", stock=rows)
...
def buy():
    ...
    if request.method == "GET":
        ...
        try:
            ...
            if shares < 0:
                return apology("Enter positie value")
        except:
